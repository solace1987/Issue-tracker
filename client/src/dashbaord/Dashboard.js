                ...
                <div class="w-2/12 bg-white rounded p-3 shadow-lg">
                    <div class="flex items-center space-x-4 p-2 mb-10">
                        ...
                        <div className='w-full flex flex-col self-center'>
                            <h4 class=" text-center font-semibold text-lg text-gray-700 capitalize font-poppins tracking-wide">{userData.name}</h4>
                    ...
                    <MainBar name={'incidence'} data={value.data} createIncident={createIncident}/>
            </div>
        </div>
