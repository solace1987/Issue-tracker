...
function Tablerow({ request }) {
    ...
    const rowData = (request, index) => {

        let date = new Date(request.timeReported)
        ...
        return (
            ...
            <tr className='text-xs' key={request._id} >
                <td className="border border-grey-500 px-2">{index + 1}</td>
                <td className="border border-grey-50 px-2 ">{request.user}</td>
                <td className="border px-2">{request.dept}</td>
                <td className="border border-grey-500 px-2 w-1/5">{request.request}</td>
                <td className="border border-grey-500 px-2 w-1/12">{formattedDate}</td>
                <td className="border border-grey-500 px-2 w-1/5">{request.timeExecuted}</td>
                <td className="border border-grey-500 px-2 w-1/12">{request.status}</td>
                <td className="border border-grey-500 px-2 w-1/5">{request.remark}</td>
                <td className=" px-2">
